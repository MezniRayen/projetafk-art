...
import tn.hounayda.utils.GestionInvestissment.EmailService;
    ...
    public void ajouterEntite(Investissement inv) {
        ...
        try (PreparedStatement ps = cnx.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            if (favoriService.hasFavoriForProjet(inv.getIdProjet())) {
                ...
                for (tn.hounayda.entities.GestionInvestissment.ProjetArtistique p : projetService.afficherEntite()) {
